...
impl PartyType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Generic1 => "PARTY_TYPE_GENERIC_1",
            Self::Generic2 => "PARTY_TYPE_GENERIC_2",
            Self::Generic3 => "PARTY_TYPE_GENERIC_3",
            Self::Generic4 => "PARTY_TYPE_GENERIC_4",
            Self::Generic5 => "PARTY_TYPE_GENERIC_5",
            Self::Generic6 => "PARTY_TYPE_GENERIC_6",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
